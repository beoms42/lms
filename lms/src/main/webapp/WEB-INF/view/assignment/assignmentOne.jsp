...
<body>
		...
		<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
			<div
				...
				<a class="navbar-brand brand-logo mr-5"
					href="${pageContext.request.contextPath}/loginCheck/main">LMS-TFT</a>
				<a class="navbar-brand brand-logo-mini"
					href="${pageContext.request.contextPath}/loginCheck/main">LMS</a>
			</div>
			<div
				...
				<ul class="navbar-nav navbar-nav-right">
					...
					<li class="nav-item nav-profile dropdown"><a
						...
						id="profileDropdown"> <img
							src="${pageContext.request.contextPath}/images/tftace.jpg"
							alt="profile" />
					</a>
													...
													<div class="card-body">
														...
														<div class="table-responsive">
															<c:forEach var="n" items="${assignmentList}">
																<table class="table table-striped">
																	<tbody>
																		...
																		<input type="hidden" id="assignmentExamNo"
																			value="${n.assignmentExamNo}">
																		<input type="hidden" id="educationNo"
																			value="${n.educationNo}">
																		<tr>
																			<td>제목</td>
																		...
																		<tr>
																			<td>내용</td>
																			<td>${n.assignmentExamContent} <script>
																				$(
																						'#summernote')
																						.summernote(
																								{
																...
																<c:if test="${level>=2 }">
																	<a
																		href="${pageContext.request.contextPath}/loginCheck/modifyAssignment?assignmentExamNo=${n.assignmentExamNo}&lectureName=${lectureName}"
																		class="btn btn-primary">수정</a>
																	<a
																		href="${pageContext.request.contextPath}/loginCheck/deleteAssignment?assignmentExamNo=${n.assignmentExamNo}"
													...
													<div class="card-body">
														...
														<div class="table-responsive">
															<c:forEach var="m" items="${assignmentSubmitTeacher}">
																<form
																	action="${pageContext.request.contextPath}/loginCheck/getScore?lectureName=${lectureName}"
																	method="get">
																	...
																	<table class="table table-hover">
																		...
																		<tbody>
																			<tr>
																				...
																				<td>${m.createDate}</td>
																				<td><img src="${m.assignmentSignfileURL}"
																					width="100%"></td>
																				<c:if test="${m.assignmentSubmitScore eq '채점중' }">
																					<td><input type="hidden" id="lectureName"
																						...
																						step="10"><br>
																					<br>
																						<button type="submit" id="sumitScore">성적
																							입력</button></td>
																				</c:if>
												...
												<div class="col-lg-12 grid-margin stretch-card">
													<div class="card">
														<div class="card-body">
															...
															<div class="table-responsive">
																<form method="POST"
																	action="${pageContext.request.contextPath}/loginCheck/getAssignmentOne?assignmentExamNo=${assignmentExamNo}"
																	id="addForm" enctype="multipart/form-data">
																	<div>
																		<textarea name="assignmentSubmitContent"
																			id="summernote" class="assignmentSubmitContent"></textarea>
																		<script>
																			$(
																					'#summernote')
																					.summernote(
																	...
																	<div>
																		<button type="button" id="addFileupload"
																			class="btn btn-primary">파일 업로드 추가</button>
																	</div>
																	<div id="fileSection">
																	...
																	<tbody>
																		...
																		<tr>
																			...
																			<c:forEach var="f" items="${fileList}">
																				<c:if test="${f.assignmentFileType.equals('image/jpeg') || f.assignmentFileType.equals('image/gif') || f.assignmentFileType.equals('image/PNG')|| f.assignmentFileType.equals('image/png') || f.assignmentFileType.equals('image/webp')}">
																					<td><a href="${pageContext.request.contextPath}/file/assignmentSubmitFile/${f.assignmentFileName}"><img src="${pageContext.request.contextPath}/file/assignmentSubmitFile/${f.assignmentFileName}" width="100%"></a></td>
																				</c:if>
	...
	<script>
				...
				.click(
						function() {
							...
							if (flag) {
								$('#fileSection')
										.append(
												"<div><input type='file' class='assignmentSubmitFileList form-control-file border' name='assignmentSubmitFileList'></div>");
							}
						});
		...
		$('#sumitScore').click(
				function() {
					if ($('#assignmentSubmitScore').val() > 100
							|| $('#assignmentSubmitScore').val() < 0) {
