											...
											<div class="table-responsive">
												<div class="container">
													<div class="container">
														<h1>과제 수정</h1>
														<form method="POST"
															action="${pageContext.request.contextPath}/loginCheck/modifyAssignment"
															id="addForm">
															<table class="table table-striped">
																<c:forEach var="n" items="${assignmentList}">
																	<input type="hidden" name="assignmentExamNo"
																		id="assignmentExamNo" value="${n.assignmentExamNo}">
																	<tr>
																		<td>제목</td>
																		<td><input type="text" name="assignmentExamTitle"
																			id="assignmentExamTitle"
																			value="${n.assignmentExamTitle}"></td>
																	</tr>
																	<tr>
																		<td>과목</td>
																		<td><input type="text" name="lectureName"
																			id="lectureName" value="${lectureName}"
																	...
																	<tr>
																		...
																		<td><textarea name="assignmentExamContent"
																				id="summernote">${n.assignmentExamContent}</textarea>
																			<script>
																				$(
																						'#summernote')
																						.summernote(
