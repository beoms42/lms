...
<body>
<form method="post" action="${pageContext.request.contextPath}/loginCheck/getBooksAction" id="addForm">
<div class="container">
   <div class="row">
...
<input name="educationNo" value="${eduNo}">
<input name="lectureSubjectNo" value="${lectureSubjectNo}">
...
<script type="text/javascript">
    ...
    $(function() {
    	...
    	$('#json').click(function() {
    		...
    		$('#photoSection').append("<input type='hidden' value='"+ImageURL+"' name='textbookSignfileName'>")
