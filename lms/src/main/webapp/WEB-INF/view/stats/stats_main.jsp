            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                  ...
                  <canvas id="lineChart" width="1180" height="590" style="display: block; width: 1180px; height: 590px;" class="chartjs-render-monitor"></canvas>
                </div>
              </div>
            </div>
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                  ...
                  <canvas id="barChart" style="display: block; width: 1180px; height: 590px;" width="1180" height="590" class="chartjs-render-monitor"></canvas>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                  ...
                  <canvas id="areaChart" width="1180" height="590" style="display: block; width: 1180px; height: 590px;" class="chartjs-render-monitor"></canvas>
                </div>
              </div>
            </div>
            <div class="col-lg-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                  ...
                  <canvas id="doughnutChart" width="1180" height="590" style="display: block; width: 1180px; height: 590px;" class="chartjs-render-monitor"></canvas>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-6 grid-margin grid-margin-lg-0 stretch-card">
              <div class="card">
                <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                  ...
                  <canvas id="pieChart" width="1180" height="590" style="display: block; width: 1180px; height: 590px;" class="chartjs-render-monitor"></canvas>
                </div>
              </div>
            </div>
            <div class="col-lg-6 grid-margin grid-margin-lg-0 stretch-card">
              <div class="card">
                <div class="card-body"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                  ...
                  <canvas id="scatterChart" width="1180" height="590" style="display: block; width: 1180px; height: 590px;" class="chartjs-render-monitor"></canvas>
                </div>
              </div>
            </div>
          </div>
